...
export const NotionPage: React.FC<types.PageProps> = ({
  ...
  console.log("🚀 ~ file: NotionPage.tsx:152 ~ lite:", lite);
  ...
  console.log("🚀 ~ file: NotionPage.tsx:215 ~ block:", block);
  console.log("🚀 ~ file: NotionPage.tsx:215 ~ site:", site);
  console.log("🚀 ~ file: NotionPage.tsx:215 ~ error:", error);
  if (error || !site || !block) {
    console.log("여기?");
